...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"start\": () => (/* binding */ start),\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _snake_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./snake.js */ \"./src/js/modules/snake.js\");\n/* harmony import */ var _feed_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./feed.js */ \"./src/js/modules/feed.js\");\n\n\nvar Game = {\n  score: 0,\n  pontuation: 5,\n  direction: \"right\",\n  // up, left, down, right\n  speed: 5,\n  core: null,\n  ground: {\n    x: 500,\n    y: 500\n  },\n  snake: {\n    size: 25,\n    x: 0,\n    y: 0\n  },\n  feed: {\n    size: 25,\n    x: 0,\n    y: 0\n  },\n  setProps: function setProps(props) {\n    Object.keys(props).map(function (key) {\n      Game[key] = props[key];\n    });\n  },\n  checkGameOver: function checkGameOver() {\n    var snake = Game.snake,\n        ground = Game.ground,\n        core = Game.core;\n    var minGround = 0;\n\n    if (snake.x < minGround || snake.x > ground.x - snake.size || snake.y < minGround || snake.y > ground.y - snake.size) {\n      alert(\"VOCÊ PERDEU\");\n      clearInterval(core);\n      return false;\n    }\n  },\n  checkColision: function checkColision() {\n    var snake = Game.snake,\n        feed = Game.feed;\n    var isCollide = !(snake.y + snake.size < feed.y || snake.y > feed.y + feed.size || snake.x + snake.size < feed.x || snake.x > feed.x + feed.size);\n\n    if (isCollide) {\n      _feed_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].add();\n      Game.updateScore();\n      Game.updateSpeed();\n    }\n  },\n  updateScore: function updateScore() {\n    var score = Game.score,\n        pontuation = Game.pontuation;\n    var newScore = score + pontuation;\n    var $score = document.getElementById(\"score\");\n    $score.innerText = \"Pontua\\xE7\\xE3o: \".concat(newScore);\n    Game.score = newScore;\n  },\n  updateSpeed: function updateSpeed() {\n    var speed = Game.speed;\n    speed += 1;\n    var $speed = document.getElementById(\"speed\");\n    $speed.innerText = \"Velocidade: \".concat(speed);\n    Game.speed = speed;\n  }\n}; // FUNCTIONS\n\nvar start = function start() {\n  _feed_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].add();\n  Game.core = setInterval(function () {\n    _snake_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].move();\n  }, 50);\n  document.addEventListener(\"keydown\", function (event) {\n    _snake_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].updateDirection(event.key);\n  });\n};\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Game);\n\n//# sourceURL=webpack://modules-2/./src/js/modules/game.js?");
